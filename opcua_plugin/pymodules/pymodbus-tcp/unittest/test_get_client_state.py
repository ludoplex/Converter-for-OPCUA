...
class TestPluginMain(unittest.TestCase):
    ...
    def test_plugin_main_get_client_state_T(self):
        res = self.t.get_client_state("127.0.0.1:5020")
        self.assertTrue(res)
        print("result:", res)

    def test_plugin_main_get_client_state_F(self):
        res = self.t.get_client_state("0.0.0.1:5020")
